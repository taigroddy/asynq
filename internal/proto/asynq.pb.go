...
const file_proto_asynq_proto_rawDesc = "" +
	"\n" +
	"\x11proto/asynq.proto\x12\x05asynq\x1a\x1fgoogle/protobuf/timestamp.proto\"\xfe\x03\n" +
	...
	"\fenqueue_time\x18\x02 \x01(\v2\x1a.google.protobuf.TimestampR\venqueueTimeB+Z)github.com/taigroddy/asynq/internal/protob\x06proto3"

var (
	file_proto_asynq_proto_rawDescOnce sync.Once
	file_proto_asynq_proto_rawDescData []byte
)

func file_proto_asynq_proto_rawDescGZIP() []byte {
	file_proto_asynq_proto_rawDescOnce.Do(func() {
		file_proto_asynq_proto_rawDescData = protoimpl.X.CompressGZIP(unsafe.Slice(unsafe.StringData(file_proto_asynq_proto_rawDesc), len(file_proto_asynq_proto_rawDesc)))
	})
	return file_proto_asynq_proto_rawDescData
}

var file_proto_asynq_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_proto_asynq_proto_goTypes = []any{
...
func file_proto_asynq_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_proto_asynq_proto_rawDesc), len(file_proto_asynq_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
